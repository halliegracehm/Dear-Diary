      ...
      <div style={S.container}>
        ...
        {loading ? (
          ...
          Object.entries(grouped).map(([tier,list])=>(
            <div key={tier} style={S.tierSection}>
              <div style={{...S.tierHeader,color:TIER_CONFIG[tier].color}}>
        ...
        {userTierLevel<1&&(
          <div style={S.upgradeBanner} onClick={onUpgrade}>
            ...
            <div style={S.upgradeSub}>Healing & Growth, Morning Routines, Anxiety & Overthinking, and more — upgrade to Community or Off the Record to join.</div>
      ...
      {hasAccess&&(
        <div style={S.composer}>
          ...
          <div style={S.composerFooter}>
            ...
            <button style={{...S.postBtn,background:cfg.color,opacity:!newPost.trim()||submitting?0.5:1}}
              disabled={!newPost.trim()||submitting} onClick={submitPost}>
          ...
          {posts.map(post=>(
            <div key={post.id} style={S.postCard}>
              ...
              <div style={S.postHeader}>
                ...
                <div style={{flex:1}}>
                  <div style={S.postAuthor}>{post.users?.username||"Anonymous"}</div>
...
const S = {
  ...
  communityCard:{ background:"rgba(255,252,246,0.95)", borderRadius:18, border:"1px solid", overflow:"hidden", transition:"transform 0.15s, box-shadow 0.15s", boxShadow:"0 2px 12px rgba(160,100,50,0.08)" },
  ...
  moodTag:{ border:"1px solid", borderRadius:20, padding:"5px 11px", fontSize:11, cursor:"pointer", fontFamily:"'Nunito',sans-serif", fontWeight:600, transition:"all 0.15s" },
  ...
  postBtn:{ color:"white", border:"none", borderRadius:20, padding:"9px 24px", fontSize:13, cursor:"pointer", fontFamily:"'Nunito',sans-serif", fontWeight:700, marginLeft:"auto", transition:"opacity 0.2s" },
  ...
  reactionBtn:{ border:"1px solid", borderRadius:20, padding:"5px 11px", fontSize:13, cursor:"pointer", fontFamily:"'Nunito',sans-serif", display:"flex", alignItems:"center", gap:4, transition:"all 0.15s" },
